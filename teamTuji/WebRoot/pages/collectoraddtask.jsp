			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="collectoraddtaskact.action" method="post"
									...
									<div class="form-group">
										<label>文件</label>
										<!-- 定义file的文件选择框，并设置name为filefile-->

										<input type="file" name="filefile" class="form-control">
									</div>
									<div class="form-group">
										<label>提交人数量</label>
										<!-- 定义submitternumber数字输入框-->
									...
									<div style='display: none;' class="form-group">
										<label>收集人</label>
										<!-- 使用el表达式给collector复制，将session中的collector赋值到input中-->

										<input value="${sessionScope.userinfo.name}" name="collector"
											class="form-control">
									</div>
									<div style='display: none;' class="form-group">
										<label>收集人id</label>
										<!-- 使用el表达式给collectorid复制，将session中的collectorid赋值到input中-->

										<input value="${sessionScope.userinfo.id}" name="collectorid"
											class="form-control">
									</div>
