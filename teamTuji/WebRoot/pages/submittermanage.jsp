											...
											<c:if test="${ !empty submitterall}">
												...
												<c:forEach items="${ submitterall}" var="item">
													...
													<tr>
														...
														<td>${item.wxnum }</td>
														<td>
															<!--  定义修改提交人按钮和删除提交人按钮，修改提交地址为updatesubmitter.action?id=${item.id}，删除提交地址为 deletesubmitter.action?id=${item.id}-->

															<a href="updatesubmitter.action?id=${item.id}">修改</a> <a
															href="deletesubmitter.action?id=${item.id}">删除</a>
