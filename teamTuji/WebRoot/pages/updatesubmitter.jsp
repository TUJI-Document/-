			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="updatesubmitteract.action" method="post"
									enctype="multipart/form-data">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> 修改提交人
									</h4>
									<input name='id' style='display: none;' value="${submitter.id}">
									<div class="form-group">
										<label>姓名</label>
										<!-- 定义姓名input输入框，并从request中取值submitter.name赋值  -->

										<input name="name" value="${submitter.name}"
											class="form-control">
									</div>
									<div class="form-group">
										<label>邮箱</label>
										<!-- 定义邮箱input输入框，并从request中取值submitter.email赋值  -->

										<input name="email" value="${submitter.email}"
											class="form-control">
									</div>
									<div class="form-group">
										<label>电话号码</label>
										<!-- 定义电话号码input输入框，并从request中取值submitter.tel赋值  -->

										<input name="tel" value="${submitter.tel}"
											class="form-control">
									</div>
									<div class="form-group">
										<label>微信号</label>
										<!-- 定义微信号input输入框，并从request中取值submitter.wxnum赋值  -->

										<input name="wxnum" value="${submitter.wxnum}"
											class="form-control">
									</div>
