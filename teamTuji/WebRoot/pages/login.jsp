		...
		<div class="card card-authentication1 mx-auto my-5">
			<div class="card-body">
				<div class="card-content p-2">
					...
					<form class="widget-form" action="loginact.action" method="post">
						...
						<button type="submit"
							class="btn btn-primary shadow-primary btn-block waves-effect waves-light">登录</button>
						<div class="text-center mt-3">登录</div>
