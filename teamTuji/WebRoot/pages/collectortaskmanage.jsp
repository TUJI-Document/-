											...
											<c:if test="${ !empty taskall}">
												...
												<c:forEach items="${ taskall}" var="item">
													...
													<tr>
														...
														<td>
															<!--  定义修改任务按钮和删除任务按钮，修改提交地址为collectorupdatetask.action?id=${item.id}，删除提交地址为 collectordeletetask.action?id=${item.id}-->

															<a href="collectorupdatetask.action?id=${item.id}">修改</a>
															<a href="collectordeletetask.action?id=${item.id}">删除</a>
