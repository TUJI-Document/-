		...
		<div id="sidebar-wrapper" data-simplebar=""
			...
			<div class="brand-logo">
				<a href="index.action"> <img
					...
					alt="logo icon">
					<h5 class="logo-text">修改提交人个人信息</h5>
				</a>
			</div>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">修改提交人个人信息</h4>
						</ol>
					</div>
				</div>
				<!-- End Breadcrumb-->
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="submitterupdategerenxinxiact.action" method="post"
									enctype="multipart/form-data">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> 修改提交人个人信息
									</h4>
									...
									<div class="form-group">
										<label>邮箱</label>
										<!--  定义email输入框，并从session中取值  -->

										<input value="${sessionScope.userinfo.email}" name="email"
											class="form-control">
									</div>
									<div class="form-group">
										<label>电话号码</label>
										<!--  定义tel输入框，并从session中取值  -->

										<input value="${sessionScope.userinfo.tel}" name="tel"
											class="form-control">
									</div>
									<div class="form-group">
										<label>微信号</label>
										<!--  定义wxnum输入框，并从session中取值  -->

										<input value="${sessionScope.userinfo.wxnum}" name="wxnum"
											class="form-control">
									</div>
