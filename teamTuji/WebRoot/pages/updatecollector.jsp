			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="updatecollectoract.action" method="post"
									enctype="multipart/form-data">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> 修改收集人
									</h4>
									<input name='id' style='display: none;' value="${collector.id}">
									<div class="form-group">
										<label>姓名</label>
										<!-- 定义姓名input输入框，并从request中取值collector.name赋值  -->

										<input name="name" value="${collector.name}"
											class="form-control">
									</div>
									<div class="form-group">
										<label>移动电话</label>
										<!-- 定义移动电话input输入框，并从request中取值collector.tel赋值  -->

										<input name="tel" value="${collector.tel}"
											class="form-control">
									</div>
