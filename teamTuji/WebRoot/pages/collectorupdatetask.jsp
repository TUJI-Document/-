			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="collectorupdatetaskact.action" method="post"
									...
									<div style='display: none;' class="form-group">
										<label>收集人</label> <input
											value="${sessionScope.userinfo.name}" name="collector"
											class="form-control">
									</div>
									<!-- 设置div display属性为none，将其隐藏 -->

									<div style='display: none;' class="form-group">
										<label>收集人id</label> <input
											value="${sessionScope.userinfo.id}" name="collectorid"
											class="form-control">
									</div>
