		...
		<div id="sidebar-wrapper" data-simplebar=""
			...
			<div class="brand-logo">
				<a href="index.action"> <img
					...
					alt="logo icon">
					<h5 class="logo-text">修改收集人个人信息</h5>
				</a>
			</div>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row pt-2 pb-2">
					<div class="col-sm-9">
						<h4 class="page-title">修改收集人个人信息</h4>
						</ol>
					</div>
				</div>
				<!-- End Breadcrumb-->
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="collectorupdategerenxinxiact.action" method="post"
									enctype="multipart/form-data">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> 修改收集人个人信息
									</h4>
