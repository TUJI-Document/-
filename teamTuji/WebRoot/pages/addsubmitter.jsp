			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="addsubmitteract.action" method="post"
									enctype="multipart/form-data">
									<h4 class="form-header">
										<i class="fa fa-file-text-o"></i> 添加提交人
									</h4>
									...
									<div class="form-group">
										...
										<input name="wxnum" class="form-control">
									</div>
