											...
											<c:if test="${ !empty submittertaskall}">
												...
												<c:forEach items="${ submittertaskall}" var="item">
													...
													<tr>
														...
														<td>${item.state }</td>
														<td>
															<!--  定义修改提交人任务按钮和删除提交人任务按钮，修改提交地址为submitterupdatesubmittertask.action?id=${item.id}，删除提交地址为 submitterdeletesubmittertask.action?id=${item.id}-->

															<a
															href="submitterupdatesubmittertask.action?id=${item.id}">修改</a>
															<a
															href="submitterdeletesubmittertask.action?id=${item.id}">删除</a>
